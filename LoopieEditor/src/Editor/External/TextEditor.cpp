...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::CSharp()
{
	...
	if (!inited)
	{
		static const char* const keywords[] = {
			...
			"ref", "return", "sbyte", "sealed", "short", "sizeof", "stackalloc", "static", "string", "struct", "switch", "this", "throw", "true", "try", "typeof",
		...
		static const char* const identifiers[] = {
			"Console", "Debug", "GameObject", "Transform", "Vector2", "Vector3", "Quaternion", "Time", "Input", "Mathf", "Random",
			"List", "Dictionary", "Array", "String", "StringBuilder", "Exception", "ArgumentException", "NullReferenceException",
			"MonoBehaviour", "Component", "Rigidbody", "Collider", "Renderer", "Camera", "Light", "AudioSource"
		};
		for (auto& k : identifiers)
		{
			Identifier id;
			id.mDeclaration = "C# built-in type or Unity class";
			langDef.mIdentifiers.insert(std::make_pair(std::string(k), id));
		}
